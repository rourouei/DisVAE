...
load_encoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_rafd_mlp/model/encoderI_epoch_49.pth'
load_decoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_rafd_mlp/model/decoderI_epoch_49.pth'
