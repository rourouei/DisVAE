...
load_encoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_rafd/model/encoderE_epoch_30.pth'
...
test_subject = [10, 19, 21, 25, 36, 39, 55, 63]
train_subject = list(range(1, 74))
for t in test_subject:
    train_subject.remove(t)
print(train_subject)
print(test_subject)
print(predict(train_subject, test_subject))
