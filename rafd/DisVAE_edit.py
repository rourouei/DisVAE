...
dirCheckpoints = dirRoot + '/code/DisVAE/checkpoints/disvae_rafd_edit1'
...
load_encoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_rafd_edit/model/encoderI_epoch_49.pth'
load_decoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_rafd_edit/model/decoderI_epoch_49.pth'
