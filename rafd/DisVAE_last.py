...
# ident 50, facenet 10
load_encoderI = dirRoot + '/code/DisVAE/checkpoints/disvae_rafd_mlp/model/encoderI_epoch_45.pth'
load_decoderI = dirRoot + '/code/DisVAE/checkpoints/disvae_rafd_mlp/model/decoderI_epoch_45.pth'
load_encoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_rafd_mlp/model/encoderI_epoch_45.pth'
load_decoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_rafd_mlp/model/decoderI_epoch_45.pth'
