...
dirCheckpoints = dirRoot + '/code/DisVAE/checkpoints/disvae_oulu_all'
...
load_encoderE = dirRoot + '/code/DisVAE/checkpoints/idnet_oulu/model/encoderI_epoch_4.pth'
load_decoderE = dirRoot + '/code/DisVAE/checkpoints/idnet_oulu/model/decoderI_epoch_4.pth'
