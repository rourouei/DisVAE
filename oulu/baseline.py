...
dirCheckpoints = dirRoot + '/code/DisVAE/checkpoints/baseline_oulu'
...
parameters3 = list(encoderI.parameters()) + list(classifier.parameters())
...
def train_DisVAE(k):
    ...
    # print('bestacc is:', bestacc)
        torch.save(encoderI.state_dict(), '{}/encoderE_epoch_{}.pth'.format(dirModel, epoch))
