...
# ident 50, facenet 10
load_encoderI = dirRoot + '/code/STVAE/checkpoints/pretrain_final/model/encoder_epoch_3.pth'
load_decoderI = dirRoot + '/code/STVAE/checkpoints/pretrain_final/model/decoder_epoch_3.pth'
load_encoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_oulu_last/model/encoderE_epoch_8.pth'
load_decoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_oulu_last/model/decoderE_epoch_8.pth'
