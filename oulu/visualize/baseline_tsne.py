...
load_encoderE = dirRoot + dirRoot + '/code/PSNRL/checkpoints/psnet_oulu1/model/encoderF_epoch_1001.pth'
load_decoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_oulu_last/model/decoderE_epoch_3.pth'
...
# bestacc, bestepoch = train_DisVAE(0)
# print('bestacc is:', bestacc)
# print('bestepoch is:', bestepoch)

expr = ['Anger', 'Disgust', 'Fear', 'Happiness', 'Sadness', 'Surprise']
for e in expr:
    ...
    for i in a:
        ...
        for root, _, fnames in os.walk(dirpath):
            ...
            for file in sorted(fnames)[-5:]:
                ...
                txt_path ='/home/njuciairs/zmy/code/DisVAE/output/' + label + '/' + str(i) + '_' + file[:-5]
