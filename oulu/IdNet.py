...
dirCheckpoints = dirRoot + '/code/DisVAE/checkpoints/idnet_oulu'
...
load_encoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_oulu_last/model/encoderI_epoch_4.pth'
load_decoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_oulu_last/model/decoderI_epoch_4.pth'
