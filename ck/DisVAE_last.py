...
dirImageoutput = dirCheckpoints + '/test_ck_recon_img'
dirTestingoutput = dirCheckpoints + '/test_ck_idvae_img'
...
load_encoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_ck_last/model/encoderI_epoch_4.pth'
load_decoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_ck_last/model/decoderI_epoch_4.pth'
...
acc, labels, preds = train_DisVAE(-1)
