...
dirCheckpoints = dirRoot + '/code/DisVAE/checkpoints/disvae_ck_last'
...
load_encoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_ck_last/model/encoderE_epoch_8.pth'
load_decoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_ck_last/model/decoderE_epoch_8.pth'
    ...
    for i in a:
        ...
        for root, _, fnames in os.walk(dirpath):
            ...
            for file in sorted(fnames)[-3:]:
                ...
                txt_path ='/home/njuciairs/zmy/code/DisVAE/output/' + str(label) + '/' + str(i) + '_' + file[:-5]
