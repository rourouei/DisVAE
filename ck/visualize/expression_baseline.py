...
load_encoderE = dirRoot + '/code/DisVAE/checkpoints/baseline_ck/model/encoderE_epoch_0.pth'
load_decoderE = dirRoot + '/code/DisVAE/checkpoints/baseline_ck/model/decoderE_epoch_0.pth'
