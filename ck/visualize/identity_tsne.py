...
dirCheckpoints = dirRoot + '/code/DisVAE/checkpoints/identity_tsne_oulu'
dirImageoutput = dirCheckpoints + '/train_oulu_img'
dirTestingoutput = dirCheckpoints + '/test_oulu_img'
dirModel = dirCheckpoints + '/model'
# ident 50, facenet 10
load_encoderI = dirRoot + '/code/DisVAE/checkpoints/disvae_ck_last/model/encoderI_epoch_4.pth'
load_decoderI = dirRoot + '/code/DisVAE/checkpoints/disvae_ck_last/model/decoderI_epoch_4.pth'
# load_encoderI = dirRoot + '/code/DisVAE/checkpoints/identity_tsne_oulu/model/encoderI_epoch_10.pth'
# load_decoderI = dirRoot + '/code/DisVAE/checkpoints/identity_tsne_oulu/model/decoderI_epoch_10.pth'
load_encoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_oulu_last/model/encoderI_epoch_9.pth'
load_decoderE = dirRoot + '/code/DisVAE/checkpoints/disvae_oulu_last/model/decoderI_epoch_9.pth'
...
def test_idnet(iteration_count):
    for epoch in range(1):
        dataset = ouluPairLoaderAlign(test_subject)
        print('# size of the current (sub)dataset is %d' % len(dataset))
        dataloader = torch.utils.data.DataLoader(dataset, batch_size=batch_size, shuffle=True,
                                                 num_workers=4)
        encoderI.train()
...
# train_idnet(-1)
rafd = oulu + '/ck_center'
ss = [10,11,14,22,26,28,29,32,34,35,37,42,44,45,46,50]
def get_z():
    for i in ss:
